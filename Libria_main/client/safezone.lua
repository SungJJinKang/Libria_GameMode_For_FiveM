...
RegisterNetEvent('Libria:setCurrentSafezone')
RegisterNetEvent('Libria:setTargetSafezone') 
...
AddEventHandler('Libria:setTargetSafezone', function(tSafezone, timer)
...
AddEventHandler('Libria:setCurrentSafezone', function(cSafezone)
